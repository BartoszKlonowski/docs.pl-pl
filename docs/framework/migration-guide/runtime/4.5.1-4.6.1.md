---
title: Zmiany w środowisku uruchomieniowym dotyczące migracji z .NET Framework 4.5.1 do 4.6.1
description: Znajdź informacje o problemach ze zgodnością aplikacji w czasie wykonywania, które mogą mieć wpływ na aplikację podczas migrowania z .NET Framework 4.5.1 do 4.6.1.
ms.date: 07/10/2019
...
ms.locfileid: "97009875"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-461"></a><span data-ttu-id="e8d78-103">Zmiany w środowisku uruchomieniowym dotyczące migracji z .NET Framework 4.5.1 do 4.6.1</span><span class="sxs-lookup"><span data-stu-id="e8d78-103">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.6.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="e8d78-104">W przypadku migrowania z .NET Framework 4.5.1 do 4.6.1 zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="e8d78-104">If you are migrating from the .NET Framework 4.5.1 to 4.6.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="e8d78-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="e8d78-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="e8d78-106">Core</span><span class="sxs-lookup"><span data-stu-id="e8d78-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="e8d78-107">Dane</span><span class="sxs-lookup"><span data-stu-id="e8d78-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="e8d78-108">Debuger</span><span class="sxs-lookup"><span data-stu-id="e8d78-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="e8d78-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="e8d78-109">Entity Framework</span></span>
...
## <a name="networking"></a><span data-ttu-id="e8d78-110">Obsługa sieci</span><span class="sxs-lookup"><span data-stu-id="e8d78-110">Networking</span></span>
...
## <a name="serialization"></a><span data-ttu-id="e8d78-111">Serializacja</span><span class="sxs-lookup"><span data-stu-id="e8d78-111">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="e8d78-112">Instalacja i wdrożenie</span><span class="sxs-lookup"><span data-stu-id="e8d78-112">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="e8d78-113">Narzędzia</span><span class="sxs-lookup"><span data-stu-id="e8d78-113">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="e8d78-114">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="e8d78-114">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="e8d78-115">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="e8d78-115">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="xml"></a><span data-ttu-id="e8d78-116">XML</span><span class="sxs-lookup"><span data-stu-id="e8d78-116">XML</span></span>
