---
title: Zmiany w środowisku uruchomieniowym dotyczące migracji z .NET Framework 4.5.1 do 4.7.1
description: Znajdź informacje o problemach ze zgodnością aplikacji w czasie wykonywania, które mogą mieć wpływ na aplikację podczas migrowania z .NET Framework 4.5.1 do 4.7.1.
ms.date: 07/10/2019
...
ms.locfileid: "97009257"
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-471"></a><span data-ttu-id="614d4-103">Zmiany w środowisku uruchomieniowym dotyczące migracji z .NET Framework 4.5.1 do 4.7.1</span><span class="sxs-lookup"><span data-stu-id="614d4-103">Runtime Changes for Migration from .NET Framework 4.5.1 to 4.7.1</span></span>

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

<span data-ttu-id="614d4-104">Jeśli przeprowadzasz migrację z .NET Framework 4.5.1 do 4.7.1, zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:</span><span class="sxs-lookup"><span data-stu-id="614d4-104">If you are migrating from the .NET Framework 4.5.1 to 4.7.1, review the following topics for application compatibility issues that may affect your app:</span></span>

## <a name="aspnet"></a><span data-ttu-id="614d4-105">ASP.NET</span><span class="sxs-lookup"><span data-stu-id="614d4-105">ASP.NET</span></span>
...
## <a name="core"></a><span data-ttu-id="614d4-106">Core</span><span class="sxs-lookup"><span data-stu-id="614d4-106">Core</span></span>
...
## <a name="data"></a><span data-ttu-id="614d4-107">Dane</span><span class="sxs-lookup"><span data-stu-id="614d4-107">Data</span></span>
...
## <a name="debugger"></a><span data-ttu-id="614d4-108">Debuger</span><span class="sxs-lookup"><span data-stu-id="614d4-108">Debugger</span></span>
...
## <a name="entity-framework"></a><span data-ttu-id="614d4-109">Entity Framework</span><span class="sxs-lookup"><span data-stu-id="614d4-109">Entity Framework</span></span>
...
## <a name="globalization"></a><span data-ttu-id="614d4-110">Globalizacja</span><span class="sxs-lookup"><span data-stu-id="614d4-110">Globalization</span></span>
...
## <a name="networking"></a><span data-ttu-id="614d4-111">Sieć</span><span class="sxs-lookup"><span data-stu-id="614d4-111">Networking</span></span>
...
## <a name="security"></a><span data-ttu-id="614d4-112">Zabezpieczenia</span><span class="sxs-lookup"><span data-stu-id="614d4-112">Security</span></span>
...
## <a name="serialization"></a><span data-ttu-id="614d4-113">Serializacja</span><span class="sxs-lookup"><span data-stu-id="614d4-113">Serialization</span></span>
...
## <a name="setup-and-deployment"></a><span data-ttu-id="614d4-114">Instalacja i wdrożenie</span><span class="sxs-lookup"><span data-stu-id="614d4-114">Setup and Deployment</span></span>
...
## <a name="tools"></a><span data-ttu-id="614d4-115">Narzędzia</span><span class="sxs-lookup"><span data-stu-id="614d4-115">Tools</span></span>

[!INCLUDE[Contract.Invariant or Contract.Requires\<TException> do not consider String.IsNullOrEmpty to be pure](~/includes/migration-guide/runtime/tools/contractinvariant-contractrequirestexception-do-not-consider.md)]

## <a name="windows-communication-foundation-wcf"></a><span data-ttu-id="614d4-116">Windows Communication Foundation (WCF)</span><span class="sxs-lookup"><span data-stu-id="614d4-116">Windows Communication Foundation (WCF)</span></span>
...
## <a name="windows-presentation-foundation-wpf"></a><span data-ttu-id="614d4-117">Windows Presentation Foundation (WPF)</span><span class="sxs-lookup"><span data-stu-id="614d4-117">Windows Presentation Foundation (WPF)</span></span>
...
## <a name="windows-workflow-foundation-wf"></a><span data-ttu-id="614d4-118">Program Windows Workflow Foundation (WF)</span><span class="sxs-lookup"><span data-stu-id="614d4-118">Windows Workflow Foundation (WF)</span></span>

[!INCLUDE[Workflow now throws original exception instead of NullReferenceException in some cases](~/includes/migration-guide/runtime/wf/workflow-now-throws-original-exception-instead-nullreferenceexception-some.md)]

[!INCLUDE[Workflow SQL persistence adds primary key clusters and disallows null values in some columns](~/includes/migration-guide/runtime/wf/workflow-sql-persistence-adds-primary-key-clusters-disallows-null-values.md)]

## <a name="xml"></a><span data-ttu-id="614d4-119">XML</span><span class="sxs-lookup"><span data-stu-id="614d4-119">XML</span></span>
