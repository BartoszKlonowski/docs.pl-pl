...
---
# <a name="runtime-changes-for-migration-from-net-framework-451-to-471"></a>Zmiany w środowisku uruchomieniowym dotyczące migracji z .NET Framework 4.5.1 do 4.7.1

[!INCLUDE[versionselector](../../../../includes/migration-guide/runtime/versionselector.md)]

Jeśli przeprowadzasz migrację z .NET Framework 4.5.1 do 4.7.1, zapoznaj się z następującymi tematami dotyczącymi problemów ze zgodnością aplikacji, które mogą mieć wpływ na aplikację:
