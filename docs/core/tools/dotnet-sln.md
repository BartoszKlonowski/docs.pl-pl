...
- **`-s|--solution-folder <PATH>`**
  ...
  Ścieżka [folderu rozwiązania](/visualstudio/ide/solutions-and-projects-in-visual-studio#solution-folder) docelowego, do którego mają zostać dodane projekty. Dostępne od wersji .NET Core 3,0 SDK.
